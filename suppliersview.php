...
// document.getElementById("search").addEventListener("keyup", liveSearch());
   ...
   var table+="<table class = 'striped highlight'>";
  ...
  if(isset($_REQUEST['txtSearch'])){
   ...
   while($row){
      ...
      echo "<td>{$row['Supplier_Email']}</td>";
       echo "<td><a href ='suppliersedit.php?us={$row['Supplier_Id']}&name={$row['Supplier_Name']}&phone={$row['Supplier_Phone']}&email={$row['Supplier_Email']}'> Edit</a></td>";
